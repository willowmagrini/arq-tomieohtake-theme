                  ...
                  <div id="<?php echo $value->ID ?>" class="candidato">
                    ...
                    <a href="#" class="user_ajax" data-id="<?php echo $user_id;?>">
                      <?php echo $user_nome; ?>
										...
										<button data-id="<?php echo $user_id;?>" class="btn btn-theme-primary">DADOS ARQUITETO PROPONENTE</button>
										<button data-id="<?php echo $user_id;?>" class="btn btn-theme-primary inscricao-finalista">DADOS PROJETO</button>
