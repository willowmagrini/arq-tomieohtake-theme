...
function your_custom_menu_item ( $items, $args ) {
    if ($args->theme_location == 'primary') {
      if (is_user_logged_in()) {
        ...
        $items .='<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item "><a class="login_button show_login_link btn btn-theme-primary" id="show_login" href="">Login</a></li>';
      }
    }
    return $items;
}
